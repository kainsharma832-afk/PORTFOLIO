export const portfolioContent = {
  ...
  nav: {
    brand: "WYQ Portfolio",
    emailHref: "mailto:3303797070@qq.com",
  ...
  about: {
    ...
    paragraphs: [
      ...
      "我目前就读于山东大学产品设计专业，是 2023 级本科生。我的学习和创作主要围绕产品设计、交互体验、视觉表达与数字化呈现展开。\n\n这个作品集记录了我在不同课程与个人项目中的设计探索，包括对用户需求、使用场景、产品形态和情绪体验的思考。我希望通过设计与技术，把想法转化为清晰、有质感、可被体验的作品。欢迎通过邮箱与我联系。",
    ],
  },
};
...
export const projects = [
  ...
  },
  {
    ...
    slug: "project-2",
    category: "Product design",
    description: "通过面部表情识别与音乐情绪引导，帮助ASD儿童在日常场景中理解他人情绪、建立共情并辅助康复训练的可佩戴产品。",
    cover: "/images/projects/project-2/cover.png",
    fullPageImage: "/images/projects/project-2/full-page.png",
    images: [
      "/images/projects/project-2/full-page.png",
    ],
  },
  {
    id: 3,
    title: "NutriGira科学喂养儿童餐椅",
    slug: "project-3",
    category: "Product design",
    description: "本设计结合BLW自主进食法与回应式喂养的优势，科学打造婴儿主导性与成人响应性结合的智能餐椅。",
    cover: "/images/projects/project-3/cover.png",
    fullPageImage: "/images/projects/project-3/full-page.png",
    images: [
      "/images/projects/project-3/full-page.png",
    ],
  },
  {
    id: 4,
    ...
    slug: "project-4",
    category: "Product design",
    description: "面向开放式办公午休场景的模块化休息系统，为带妆职场用户提供不压脸、护颈部、少干扰且易收纳的短时休息体验。",
    cover: "/images/projects/project-4/cover.png",
    fullPageImage: "/images/projects/project-4/full-page.png",
    images: [
      "/images/projects/project-4/full-page.png",
    ],
  },
  {
    id: 5,
